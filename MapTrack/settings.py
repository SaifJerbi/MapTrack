# Django settings for MapTrack project.
import os
gettext = lambda s: s
...
SECRET_KEY = 'w2)*ou6x4m68sj_np3$q!1i8ne7r*yzd_&amp;rv5qbx*db44pr*cm'
...
ROOT_URLCONF = 'MapTrack.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'MapTrack.wsgi.application'
